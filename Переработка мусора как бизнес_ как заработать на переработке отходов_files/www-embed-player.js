...
function Ih(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||E("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Vk||E("AUTHORIZATION"))||(a?b="Bearer "+A("gapi.auth.getToken")().Uk:b=gd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=E("SESSION_INDEX",0),O("pageid_as_header_web")&&(d["X-Goog-PageId"]=E("DELEGATED_SESSION_ID")));return d}
...
v(Q,ki);function ui(a){Q.call(this,"MISSING_OBJECT_STORE",{Zk:a},pi.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,ui.prototype)}
...
Jk();c=u(a.S);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Yk)){a=d.weight;break a}a=u(a.R);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ca(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Ek);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.ya[l.name])for(e=u(c.ya[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
...
Hk:93044,Ik:93045,Jk:34388,Kk:17657,Lk:17655,Mk:39579,Nk:39578,Ok:77448,Pk:8196,Qk:11357,Rk:69877,Sk:8197,Tk:82039};function $k(){var a=kb(al),b;return Oe(new He(function(c,d){a.onSuccess=function(e){tg(e)?c(new bl(e)):d(new cl("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
return a.join("")}
;var ql,rl=y.ytLoggingDocDocumentNonce_;rl||(rl=pl(),Qa("ytLoggingDocDocumentNonce_",rl));ql=rl;var sl={je:0,ic:1,qc:2,ph:3,le:4,Bk:5,ci:6,fj:7,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE"};function tl(a){this.h=a}
...
h.visualElement?t.implicitGesture={parentCsn:h.clientScreenNonce,gesturedVe:h.visualElement.getAsJson()}:h&&Wk(new ki("newScreen() parent element does not have a VE - rootVe",b));l&&(t.cloneCsn=l);l={G:n,U:p};k?wh("screenCreated",t,k,l):Dk("screenCreated",t,l);Wh(Zh,new El(p));var q=p}catch(D){Yk(D,{dl:b,rootVe:d,parentVisualElement:void 0,Xk:e,bl:f,Ea:c.Ea});Xk(D);return}Dl(q,b,c.layer,c.G);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=O("screen_manager_skip_hide_killswitch"))){a:{b=u(Object.values(sl));
